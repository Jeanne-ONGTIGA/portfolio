...
export default function Home() {
 const [user, setUser] = useState<GithubUser | null>(null);
   const [userRepo, setUserRepo] = useState<GithubRepo[]>([]);
   const githubUsername = "Jeanne-ONGTIGA";
   ...
   return (
     ...
     >
       <div className="pt-1 m-auto max-w-4xl">
         <nav className="flex items-center justify-between">
           <h1 className="text-3xl text-[#e2ebf8] font-medium font-['Fonarto']">
             <span className="text-[#05BFDB]">Jeanne</span>.codes
           </h1>
           <div className="flex gap-x-3">
             <a href="http://dxgkr.nl/">
         ...
         <main className="py-36">
           <div className="flex flex-row gap-x-5">
             ...
             <div className="flex-col">
               ...
               <div className="flex py-8 font-bold">
                 ...
                 <a href="https://github.com/Jeanne-ONGTIGA">
           ...
           <div>
             <h1 className="text-2xl text-black font-semibold mt-9">
              Mes projets phares: un aperçu de ce que je sais faire 🤗
             </h1>
             <p className="fp-paragraph">
              Une selection de projet recemment codés. Chaque idée a commencé comme un simple test... Mais pourra finir en quelque chose de concret et fonctionnel !
             </p>
